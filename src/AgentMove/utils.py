...
def token_count(text):
    try:
        ...
        # TokenCount/tiktoken may try to download an encoding on first use.
        # Keep inference usable offline; provider-reported usage remains the
        # authoritative measurement for RQ3.
